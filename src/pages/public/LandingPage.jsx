...
const categories = [
  { label: 'Gaming News', icon: Zap, to: '/gaming', desc: 'Latest game releases & updates' },
  { label: 'Hardware', icon: Monitor, to: '/hardware', desc: 'Reviews, specs & benchmarks' },
  { label: 'Esports', icon: Trophy, to: '/esports', desc: 'Live scores & tournaments' },
  { label: 'Trending', icon: TrendingUp, to: '/culture', desc: 'What the community is talking about' },
];
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
      ...
      <section className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
        {categories.map(({ label, icon: Icon, to, desc }) => (
          <Link key={label} to={to} className="gnewz-card flex flex-col gap-2 p-4 group">
            ...
            <div key={i} className="gnewz-card p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="px-4 text-center">
                  ...
                  <p className="text-[10px] text-orange font-700 uppercase tracking-wider mt-0.5">Live</p>
                </div>
                <div className="text-center flex-1">
                  <div className="w-10 h-10 rounded-full bg-[#2a2a2a] mx-auto mb-1 flex items-center justify-center text-lg font-900 text-orange">
                    {m.t2[0]}
