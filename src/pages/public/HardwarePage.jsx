    ...
    >
      <div className="flex items-center gap-3 px-4 py-3 border-b border-[#1a1a28]">
        ...
        <input
          ...
          placeholder="Search hardware articles…"
...
function Sidebar() {
  return (
    <aside className="flex flex-col gap-8">
      <LatestNewsWidget categorySlug="hardware" />
      <TopArticlesWidget />
...
export default function HardwarePage() {
  ...
  const resultTitle = (() => {
    ...
    if (period === "today") return "Today's Hardware News";
    if (period === "week") return "This Week in Hardware";
    if (period === "month") return "This Month in Hardware";
    return "Latest Hardware News";
  })();
