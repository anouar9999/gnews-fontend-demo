...
import { LandingSectionsProvider } from "../context/LandingSectionsContext";
      ...
      >
        <g fill="none" stroke="#1a1a2a" strokeWidth="1.4" opacity="0.9">
          ...
          <g transform="translate(60, 100) rotate(-14) scale(1.15)">
            ...
            <circle cx="75" cy="21" r="3.5" />
            <circle cx="67" cy="29" r="3.5" />
            <circle cx="59" cy="21" r="3.5" />
          ...
          <g transform="translate(70, 720) rotate(6) scale(1.05)">
            ...
            {[8, 28, 48, 68, 88, 108, 128, 148].map((x, i) => (
              <rect key={i} x={x} y="8" width="14" height="11" rx="2" />
            ))}
            {[8, 28, 48, 68, 88, 108, 128, 148, 168].map((x, i) => (
              <rect key={i} x={x} y="25" width="14" height="11" rx="2" />
            ))}
